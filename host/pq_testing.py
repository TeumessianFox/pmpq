...
POLYMUL_ALGOS = ["TEXTBOOK", "HALF_TEXTBOOK"]


def init(algo: str):
    logging.info("#### Running {} ####".format(algo))
    with open("../polymul/auto_python_tests.h", 'w') as f:
        f.write("/* Auto-generated by python pq_testing.py */\r\n")
        f.write("/* Please don't make any changes to this file manually*/\r\n")
        f.write("#define POLYMUL " + algo)
        logging.debug("auto_python_tests.h created!")
    with open("../polymul/auto_python_file.mk", 'w') as f:
        f.write("# Auto-generated by python pq_testing.py\r\n")
        f.write("# Please don't make any changes to this file manually\r\n")
        f.write("CFILES += " + algo.lower() + ".c")
        logging.debug("auto_python_file.h created!")
    m4serial.init()
